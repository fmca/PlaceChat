...
(function($, window, document, undefined) {
    var defaults = {bounds: true, country: "br", map: false, details: false, detailsAttribute: "name", autoselect: true, location: false, mapOptions: {zoom: 14, scrollwheel: false, mapTypeId: "roadmap"}, markerOptions: {draggable: false}, maxZoom: 16, types: ["geocode"], blur: false};
